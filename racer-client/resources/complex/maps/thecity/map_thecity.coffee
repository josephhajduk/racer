...
exports.process = (options)->
  ...
  #create below layer from layer2 and layer1
  exec "/usr/local/bin/composite #{resource_file}[3] #{resource_file}[2] #{resource_file}[1] #{options.output}/resources/maps/thecity/below.png"
